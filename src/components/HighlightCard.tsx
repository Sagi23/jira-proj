...
const HighlightCard: FC<HighlightCardProps> = ({ amount, title, total }) => {
  ...
  return (
    <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow transform transition-all mb-4 w-full sm:w-1/4 sm:my-8 -z-10">
